...
describe('Component TripSummary', () => {
  ...
  it('should render correct src and alt for image', () => {
    ...
    const component = shallow(<TripSummary id='1234' image={expectedSrc} name={expectedAlt} cost='$51' days={3} tags={['tag1','tag2']}  />);
  ...
  it('should render props name, cost and days', () => {
    ...
    const component = shallow(<TripSummary id='1234' image='image.png' name={expectedName} cost= '$51' days={3} tags={['tag1','tag2']}  />);
  ...
  it('should render 3 tags in span in order', () => {
    ...
    const component = shallow(<TripSummary id='1234' image='image.png' name='Australia' cost='$51' days={3} tags={['one', 'two', 'three']} />);
  ...
  it('should not render div without tags', () => {
    const component = shallow(<TripSummary id='1234' image='image.png' name='Australia' cost='$51' days={3}  tags={[]} />);
